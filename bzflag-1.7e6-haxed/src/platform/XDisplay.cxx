...
*/
  ...
  //CHEAT:
  //scroll mouse capability
  case Button4: event.keyDown.button = BzfKeyEvent::MiddleMouse; event.keyDown.ascii = 1; break;
  case Button5: event.keyDown.button = BzfKeyEvent::MiddleMouse; event.keyDown.ascii = 2; break;
